...
export const DashboardIssuedMonthlyCard: React.FC<Props> = observer(() => {
  const { routing } = useStores();

  return (
    <DashboardCard>
      <DashboardCardHead>
        <Text>Issued Monthly:</Text>
      </DashboardCardHead>
      <DashboardCardBody>
...
DashboardIssuedMonthlyCard.displayName = 'DashboardIssuedMonthlyCard';
